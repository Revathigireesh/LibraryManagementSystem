...
<%
    ...
    if (bookID != null && !bookID.isEmpty()) {
        ...
        try {
            ...
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/adminlogin", "root", "your_password");
            String sql = "UPDATE requestedbooks SET status = 'Rejected' WHERE BookID = ?";
